/*
 * external libraries used: adafruit_neopixel, timer library from http://playground.arduino.cc/Code/Timer
 * 
 * this is the final stable code that was used in fashion-wearable makerthon project.
 * 
 */
